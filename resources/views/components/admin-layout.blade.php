    ...
    <aside class="w-72 bg-[#FDFBF7] border-r border-stone-200 p-6 flex flex-col justify-between hidden md:flex">
        <div>
            ...
            <nav class="space-y-1.5">
                ...
                <a href="{{ route('admin.verification') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl font-medium text-sm transition {{ request()->routeIs('admin.verifications') ? 'bg-red-700 text-white shadow-sm' : 'text-slate-600 hover:bg-stone-100' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
                <span>Verifications</span>
                </a>
                <a href="{{ route('admin.job-moderation') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl font-medium text-sm text-slate-600 hover:bg-stone-100 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                    <span>Job moderation</span>
                </a>
                <a href="{{ route('admin.users') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl font-medium text-sm text-slate-600 hover:bg-stone-100 transition">
                ...
                <a href="{{ route('admin.settings') }}" class="flex items-center space-x-3 px-4 py-3 rounded-xl font-medium text-sm text-slate-600 hover:bg-stone-100 transition">
    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <header class="h-20 px-8 flex items-center justify-between border-b border-stone-200/60 bg-[#FDFBF7]">
            <div>
                ...
                <p class="text-xs text-slate-500 font-medium">Pinamalayan, Oriental Mindoro · updated 2 minutes ago</p>
            </div>
